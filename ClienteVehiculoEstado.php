			...
			<div class="col-md-0">
				<div class="box box-primary">
					<div class="box-header with-border">
						...
						<div class="col-md-0 pull-left" ><h3><i class="fa fa-car text-red" style="font-size:36px;" pull-left></i>&nbsp;&nbsp;ESTADO CUENTA CLIENTE / VEHICULO</h3></div>
					</div>
                    ...
                    <div class="form-group"> 
                      ...
                      <div class="col-sm-3">
                        <div class="input-group">
                          <div class="input-group-btn"><button type="button" class="btn btn-warning" onclick="ConsultarVin(1)"><i class="fa fa-search-plus"></i></button>></div>
                          <input type="text" id="vin" name="vin" class="form-control " placeholder="" disabled>
                        </div>
                        <span id="help1" class="label label-danger"></span>
                      </div>
                      <div class="col-sm-9"><input type="text" id="vin-nombre" name="vin-nombre" class="form-control" placeholder="" disabled></div>
                    </div> 

                    <div class="form-group"> 
                      <div class="col-sm-12"><label class=" control-label">CLIENTE CI:</label></div>
                      <div class="col-sm-3">
                        <div class="input-group">
                          <div class="input-group-btn"><button type="button" class="btn btn-warning" onclick="ConsultarVin(2)"><i class="fa fa-search-plus"></i></button>></div>
                          <input type="text" id="cliente" name="cliente" class="form-control" placeholder="" disabled>
                        </div>
                        <span id="help2" class="label label-danger"></span>
                      </div>
                      <div class="col-sm-9"><input type="text" id="cliente-nombre" name="cliente-nombre" class="form-control" placeholder="" disabled></div>
                    </div> 
