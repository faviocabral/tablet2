...
<div class="container-fluid" style="margin:10px; position: relative;">
        <div class="row"> 
            ...
            <br> 
		  		<h2 style="margin:0px;">Garden S.A.</h2> 
                <p style="font-size:10px;">Avda. San Blas esq. O'higgins Tel (+595 21) 237 6910 | (595)(893)777013<br>mail:servicioscde@garden.com.py | Ciudad del Este, Paraguay </p> 
  ...
  <table id="contenido" >
    ...
    <tbody>
      <tr>
      	<td colspan=4>
      		<span style="margin-right: 3px;"><strong>Fecha Recepcion: </strong> <span id="FechaApertura"></span></span>
      		...
      		<p style="margin-bottom: 0px;">
	      		<span style="margin-right: 5px;"><strong>Nro Documento: </strong><span id="NroDocumento"></span> </span>
	      		...
	      		<span style="margin-right: 5x;"><strong>CONTACTO CLIENTE: </strong><span id="contacto_cliente"></span> </span>
	      		<span style="margin-right: 5x;"><strong>EMAIL CLIENTE: </strong><span id="contacto_email"></span> </span>
      		</p>
      	</td>
      </tr>
      ...
      <tr> 
      		<td colspan="2" style="width:10%;" id="list-accesorios">
				<p><b>Ducha de Cortesia: si(_) no(_)</b></p>
				<p><b>Precio Estimado del Servicio: ___________</b></p>
			...
			<td colspan="1" rowspan="6" style="width:40%;">
      			<center><img src="vehiculo2.png" class="img-rounded detalle_vehiculo" alt="Cinque Terre" width="90%" height="90%"> </center>
      		</td>
      </tr>
	  ...
	  <!--
	  <tr> <td colspan="4" style="width:20%; text-align: justify"> <p style="font-size:10px; margin:0px; position: relative;">Autorizo al Dpto. de Servicios de Garden SA a realizar los trabajos apuntados mas arriba. Asi mismo a la provision de los repuestos y materiales que sean necesarios; las piezas sustituidas en las reparaciones estaran a disposicion hasta el momento del retiro del vehiculo. Autorizo tambien a las pruebas del vehiculo fuera del taller en las calles y rutas para garantizar los trabajos realizados. Garden SA tendra derecho a cobrar 15.000 GS por dia en concepto de estacionamiento y seguro a partir de las 24 horas de la fecha de notificacion para el retiro del vehiculo. La empresa no se responsabiliza por los objetos de valor dejados dentro del vehiculo. En caso de incumplimiento de pago por los servicios contratados, el presente instrumento se constituye en título ejecutivo, de conformidad a los artículos 439 y 448, inciso b) del C.P.C. 
...
De conformidad a lo establecido en el artículo 1.826 del Código Civil Paraguayo, Garden S.A. podrá ejercer derecho de retención del vehículo hasta el cobro íntegro del 
crédito exigido.</p>
		</td></tr>
-->
  ...
  <table style="width:100%; margin-top:30px; position: relative;" id="ticket">
	<tbody>
      ...
      <tr> <td colspan="8" rowspan="2" style="width:60%;"> 
				<strong><p style="margin-bottom:0px; text-align: center;"> Garden S.A.</p></strong> 
				<p id="sucu-direccion" style="font-size:10px;margin-bottom:0px; text-align: center;">Avda. San Blas esq. O'higgins Tel (+595 21) 237 6910 | (595)(893)777013<br>mail:servicioscde@garden.com.py | Ciudad del Este, Paraguay </p>
				...
				<p style="font-size:9px;margin-bottom:0px;"> * Horario de Atencion del Dpto. de Servicios de 07:00 a 12:00 hs y 13:00 a 17:00 de Lunes a Viernes | Sabado de 07:00 a 11:30 hs. </p>
				...
				-->
				<p style="font-size:9px;margin-bottom:0px;"> * Para mantener el turno en el taller el presupuesto debera ser aceptado entre las 48 hs. </p>
				<p style="font-size:9px;margin-bottom:0px;"> * Horario de Atencion del Dpto. de Servicios de 07:00 a 12:00 hs y 13:00 a 17:00 de Lu - Vie Sab de 07:00 a 11:30 hs. </p>
				<p style="font-size:9px;margin-bottom:0px;"> * El ticket sera requerido para el retiro del vehiculo. </p> 
				...
				rs.forEach( function ( rs2 ){ //fco recorre la lista de resultados por cada  objeto[](campos[])
					...
					Object.keys(rs2).forEach(function(key) { //fco recorre los campos con sus valores 
						...
						//copiar en todos 
							...
							Campaña(valor.slice(-17));
							ConsultarPlanPlus(valor.slice(-8));
						}
