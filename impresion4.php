...
<div class="container-fluid" style="margin:10px; position: relative;">
        <div class="row"> 
        	...
        	<div class="col-xs-6 text-left" style="padding-left:125px; padding-right: 0px; position: relative;"> 
            <br> 
		  		<h2 style="margin:0px;">GARDEN MPY S.A.</h2> 
                <p style="font-size:10px; margin: 0px;">Republica Argentina c/ Facundo Machain<br> 
                <p style="font-size:10px; margin: 0px;">Tel.: (+595 21)237-7888 - Int.: 255 - Cel: +595 982 946 597<br> 
                serviciosmini@garden.com.py - Asuncion Paraguay</p> 
                <img src="logo-mazda.jpg" alt="Mazda" width="100" height="90" style="position: absolute; top:8px; left:25px;" >
            </div> 
        ...
        <div class="row" style="margin-bottom: 5px;">
        	<div class="col-xs-12 text-right"> <span class='badge'  style='font-size:14px;' id="PlanPlus3"> <i class="fa fa-spinner fa-spin fa-1x fa-fw"></i> </span> <span id="mora" class="badge"> <i class="fa fa-spinner fa-spin fa-1x fa-fw"></i> </span> </div>	
        </div>   
  ...
  <table id="contenido" >
    ...
    <tbody>
      ...
      <tr>
      	<td></td>
      	<td></td>
      	<td><strong>Chapa:</strong> </td><td id="Chapa">ABC123 </td>
      </tr>	
      <tr>
      	<td></td>
      	<td></td>
  ...
  <table style="width:100%; margin-top:10px; position: relative;" id="ticket">
	<tbody>
      ...
      <tr> <td colspan="8" rowspan="2" style="width:60%; position: relative;"> 
                <img src="logo-mazda.jpg" alt="Mazda" width="50" height="47" style="position: absolute; top:2px; left:2px;" >

				<strong><p style="margin-bottom:0px; margin-left: 50px"> GARDEN MPY S.A.</p></strong>
				<p style="font-size:10px;margin-bottom:5px; margin-left: 50px;">Republica Argentina c/ Facundo Machain Tel.: (+595 21)237-7888 Int.: 255 <br> Email: serviciosmini@garden.com.py - Cel: +595 982 946 597 - Asuncion Paraguay </p>
...
<script>
	$(document).ready(function(){
		...
		//alert( NroOt );	
		//aqui le pasamos la sucursal directamente -> MPY !!!!!
		let sucu = localStorage.getItem("sucursal")
				...
				rs.forEach( function ( rs2 ){ //fco recorre la lista de resultados por cada  objeto[](campos[])
					...
					Object.keys(rs2).forEach(function(key) { //fco recorre los campos con sus valores 
						...
						if (key == 'FechaApertura' ){ 
							...
							ConsultarMora(valor);
							ConsultarPlanPlus(valor.slice(-17))
							console.log(valor);	
						}
		...
		if ( $("#contenido").height() > 740 ){
			...
			//valor = 1180 - valor ; 
			valor = 1295 - valor ;  // modificar este valor para ajustar la altura del ticket para la impresion 
   ...
   function ConsultarMora(chassis){ 
      ...
      $.ajax( { method: "POST", url: "consulta.php", data : {vin : chassis , funcion: 'ConsultarMora' , sucursal: 'mpy' }, dataType: 'json' }) 
      .done(function( rs ) { 
        ...
        if ( rs.length >0  ){ 
            ...
            //if (mora > 0 ){
			  mora = rs[0]['mora'];
			  console.log('valor de la mora... ' , rs );
			if (Number(mora) > 0 ){ 
            ...
            //     }
				mensaje = 'Cliente al Dia !';
	          $("#mora").html("<span class='glyphicon glyphicon-ok'></span>"+ mensaje );
        ...
        //   $("#mora").css("visibility","visible");
          ...
          //$("#mora").html("<span class='badge'  style='font-size:14px;'><span class='glyphicon glyphicon-ok'></span> 10 dias de Mora con Plan Plus 3 Service Basico Gratuito !!! </span>" );
