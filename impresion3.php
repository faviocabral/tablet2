...
<div class="container-fluid" style="margin:10px; position: relative;">
        <div class="row"> 
        	...
        	<div class="col-xs-6 text-center"> 
        		<div class="row">
					<img class="img-rounded text-left" src="logo_garden.png" alt="Chania" width="60" height="55" style="margin-top: 5px; margin-left: -50px;"> 
					<img class="img-rounded text-right" src="logo_mini.jpeg" alt="Chania" width="130" height="60" style="margin-top: 8px; margin-left: 110px;">
					<p style="margin-left: 20px; font-size: 8px; margin-bottom: 0px;" class="text-left">Republica Argentina c/ Facundo Machain 
		          Tel.: (+595 21)237-7888 Int. 255
				  Email: serviciosmini@garden.com.py - Cel: +595 982 946 597
		          Asuncion - Paraguay
					</p> 
	        	</div>	
...
-->
	...
	<tr> 
		...
		<td colspan="2" id="PedidoCliente" style="font-size: 11px;">el cliente reclama que el auto hace mucho ruido </td> 
	</tr>
  ...
  <table style="width:100%; margin-top:10px; position: relative;" id="ticket">
	<tbody>
      ...
      <tr> <td colspan="8" rowspan="2" style="width:60%; position: relative;"> 
      	        <img src="logo_mini.jpeg" alt="Mazda" width="75" height="42" style="position: absolute; top:2px; left:2px;" >

				<strong><p style="margin-bottom:0px; margin-left: 75px;"> Garden Automotores S.A.</p></strong> 
				<p style="font-size:10px;margin-bottom:0px; margin-left: 75px;">Republica Argentina c/ Facundo Machain Tel.: (+595 21)237-7888 Int.: 255 <br> Email: serviciosmini@garden.com.py - Cel: +595 982 946 597</p>
...
-->	
				...
				<p style="font-size:9px;margin-bottom:0px;"> * Horario Atencion de Servicios de 07:30 a 18:00 hs de Lu - Vie Sab de 07:30 a 12:00 hs. </p>
   ...
   function ConsultarMora(chassis){ 
	...
	async function ConsultarPlanMini(chassis){
      ...
      if(datos.length > 0 ){
		...
		$("#planMini").html(
							"<span class='badge'  style='font-size:14px;'><span class='glyphicon glyphicon-bell'></span> Promocion ventas 2023 Garantia extendida - Servicio Gratuito "+
							`${(datos[0]['vigenciaMes'] > 36 )? '<span class="glyphicon glyphicon-remove "></span>': '<span class="glyphicon glyphicon-ok "></span>'} `+
							" "+  datos[0]['vigenciaMes'] + "/36 meses </span>" );
        return 
      } 
