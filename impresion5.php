...
<div class="container-fluid" style="margin:10px; position: relative;">
        <div class="row"> 
            ...
            <br> 
		  		<h2 style="margin:0px;">Cuevas Hermanos <span style="font-size: 12px;">SA</span></h2> 
                <p style="font-size:10px; text-align: center;"> Tel.: (+595 21)619-8000</p> 
				<img src="logo-nissan.jpg" alt="Mazda" width="100" height="90" style="position: absolute; top:8px; left:25px;">                
            </div> 
		...
		<div class="row" style="margin-bottom: 5px;">
        	...
        	<div class="col-xs-4 text-right"> <span id="mora"> <i class="fa fa-spinner fa-spin fa-3x fa-fw"></i> </span> </div>	
        </div> 
  ...
  <table id="contenido" >
    ...
    <tbody>
	  ...
	  <tr style="background-color:#eee !important;"> <td colspan="2"><strong> -</strong></td> <td colspan="1"><strong> COMBUSTIBLE</strong></td> <td colspan="1"><strong> DETALLE EXTERNO</strong></td></tr>
      <tr> 
	  ...
	  <tr> <td colspan="4" style="width:20%; text-align: justify"> 
<!--	  
	  	<p style="font-size:10px; margin:0px; position: relative;">Autorizo al Dpto. de Servicios de Cuevas Hermanos SA a realizar los trabajos apuntados mas arriba. Asi mismo a la provision de los repuestos y materiales que sean necesarios; las piezas sustituidas en las reparaciones estaran a disposicion hasta el momento del retiro del vehiculo. Autorizo tambien a las pruebas del vehiculo fuera del taller en las calles y rutas para garantizar los trabajos realizados. Cuevas Hermanos SA tendra derecho a cobrar 15.000 GS por dia en concepto de estacionamiento y seguro a partir de las 24 horas de la fecha de notificacion para el retiro del vehiculo. La empresa no se responsabiliza por los objetos de valor dejados dentro del vehiculo. En caso de incumplimiento de pago por los servicios contratados, el presente instrumento se constituye en título ejecutivo, de conformidad a los artículos 439 y 448, inciso b) del C.P.C. 
	  En caso de retiro de repuestos sustitutos, manifiesto asumir responsabilidad respecto a su destino, disposición y uso comprometiéndome a dar cumplimiento a disposiciones legales y/o normativas que regulen la utilización de los mismos. 
	  En caso de haber arrendado un vehículo, conjuntamente con el pago de servicio del taller deberá ser abonado el costo del arrendamiento.-
De conformidad a lo establecido en el artículo 1.826 del Código Civil Paraguayo, Garden Automotores S.A. podrá ejercer derecho de retención del vehículo hasta el cobro íntegro del 
crédito exigido.</p> 
-->
	<p style="font-size:10px; margin:0px; position: relative;">	<b>Autorización al Dpto. de Servicios de Cuevas Hermanos S.A. a:</b> Realizar los trabajos apuntados más arriba mediante la provisión de los repuestos y materiales que sean necesarios. A las pruebas del vehículo fuera del taller en las calles y rutas para garantizar los trabajos realizados. </p>
	<p style="font-size:10px; margin:0px; position: relative;"><b>Informamos al Cliente que:</b> La empresa tendrá derecho a cobrar 30.000 Gs. por día en concepto de estacionamiento y seguro a partir de las 24 horas de la fecha de notificación para el retiro del vehículo. La empresa no se responsabiliza por los objetos de valor dejados dentro del vehículo. Los datos proporcionados podrán ser utilizados en acciones de marketing, encuestas de calidad y llamadas de seguimiento. En caso de incumplimiento de pago por los servicios contratados, el presente instrumento se constituye en título ejecutivo, de conformidad a los artículos 439 y 448, inciso b) del C.P.C. De conformidad a lo establecido en el artículo 1.826 del Código Civil Paraguayo, Cuevas Hermanos S.A. podrá ejercer derecho de retención del vehículo hasta el cobro íntegro del crédito exigido. En caso de haber arrendado un vehículo, conjuntamente con el pago de servicio del taller deberá ser abonado el costo del arrendamiento.</p>
	<p style="font-size:10px; margin:0px; position: relative;"><b>Retiro de Repuestos:</b> Las piezas sustituidas en las reparaciones; las cuales fueron abonadas por el cliente estarán a disposición hasta el momento del retiro del vehículo (a excepción de los aceites o filtros de motor y combustibles).Yo cliente, manifiesto asumir responsabilidad respecto a su destino, disposición y uso comprometiéndome a dar cumplimiento a disposiciones legales y/o normativas que regulen la utilización de los mismos</p>
</td></tr>
  ...
  <table style="width:100%; margin-top:17px; position: relative;" id="ticket">
	<tbody>
      ...
      <tr> <td colspan="8" rowspan="2" style="width:60%;"> 
      			<img src="logo-nissan.jpg" alt="Mazda" width="50" height="47" style="position: absolute; top:43px; left:15px;">
				<strong><p style="margin-bottom:0px; text-align: center;"> Cuevas Hermanos S.A.</p></strong> 
				<!-- <p id="sucu-direccion" style="font-size:10px;margin-bottom:0px; text-align: center;">SUC FERNANDO MORA - AVDA. FDO DE LA MORA 5454 C/S BRUNO GUGGIARI </p>
				<p id="sucu-direccion" style="font-size:10px;margin-bottom:0px; text-align: center;">SUC ABAY - ABAY NRO 452 ENTRE MEXICO Y CABALLERO Tel.: (+595 21)619-8000 - Asuncion Paraguay </p> -->
				<p id="sucu-direccion" style="font-size:10px;margin-bottom:0px; text-align: center;">Tel.: (+595 21)619-8000 </p>
<!--				 
				<p style="margin-bottom:0px; font-size: 11px; text-align: center"><strong> ADVERTENCIA</p></strong> 
				...
				<p style="font-size:9px;margin-bottom:0px;"> * Horario de Atencion del Dpto. de Servicios de 07:30 a 18:00 hs de Lunes a Viernes Sabado de 08:00 a 12:00 hs. </p>
...
-->				
				<p style="margin-bottom:0px; font-size: 11px; text-align: center"><strong>Estimado Cliente</p></strong> 
				<p style="font-size:9px;margin-bottom:0px;">* Para mantener el turno en el taller el presupuesto deberá ser aceptado entre las 48 hs.</p>
				<p style="font-size:9px;margin-bottom:0px;">* Horario de Atención del Dpto. de Servicios de 07:30 a 18:00 hs de Lunes a Viernes Sábado de 07:30 a12:00 hs.</p>

				<p style="font-size:9px;margin-bottom:0px;">* El ticket será requerido para el retiro del vehículo. </p>
...
<script>
	$(document).ready(function(){
		...
		$.ajax( { method: "POST", url: "consulta.php", data : { NroOt : NroOt , funcion: 'ConsultarOt', sucursal: '003' }, dataType: 'json'})
...
//copiar en todos... 
   function ConsultarMora(chassis){ 
      ...
      $.ajax( { method: "POST", url: "consulta.php", data : {vin : chassis , funcion: 'ConsultarMora' , sucursal: '003' }, dataType: 'json' }) 
      .done(function( rs ) { 
        if ( rs.length > 0  ){ 
            ...
            if (mora > 0 ){
			  ...
			  if(rs[0]['plan_familiar3'] == 'si'){
                  mensaje = '' + mora + ' dias de Mora con Plan Plus 3 Service Basico Gratuito !!!';
                }else{
    ...
    function ConsultarPlanPlus(chassis){
      ...
      .done(function( rs ) { 
		  console.log('consulta plan plus 3 ', rs );
        if ( rs ){ 
            if (rs.length > 0 ){
              //console.clear();
