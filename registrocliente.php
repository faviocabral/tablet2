...
<html>
 ...
 <!-- <body class="sidebar-mini skin-red fixed sidebar-collapse" onbeforeunload="return '' ">  este evento onbeforeunload evita recargar la pagina fco --> 
  <body class="sidebar-mini skin-red fixed sidebar-collapse" >
			...
			<div class="col-md-0">
				<div class="box box-primary">
					<div class="box-header with-border">
						...
						<div class="col-md-0 text-center" ><h3><i class="fa fa-user text-red" style="font-size:36px;" pull-left></i><br>REGISTRO DE CLIENTES</h3></div>
					</div>
						...
						<div class="box-body">
							<div class="row">
								...
								<div class="box box-success box-solid">
									<div class="box-body">	
										<h4 class="box-title"><i class="fa fa-gear text-green"></i>&nbsp;&nbsp;DATOS:</h4>

                    <div class="form-group"> 
                      <div class="col-sm-12">
                        <div class="input-group">
                          <div class="input-group-btn"><button type="button" class="btn btn-warning"style="width:90px;" ><i class="fa fa-user"></i> Nombre:</button>></div>
                    ...
                    <div class="form-group"> 
                      <div class="col-sm-12">
                        <div class="input-group">
                          <div class="input-group-btn"><button type="button" class="btn btn-warning" style="width:90px;"><i class="fa fa-phone"></i> Telefono:</button>></div>
                          <input type="text" id="telefono" name="telefono" class="form-control" placeholder="" >
                        </div>
                        <span id="help2" class="label label-danger"></span>
                      </div>
                    </div> 
                    ...
                    <div class="form-group"> 
                      <div class="col-sm-12">
                        <div class="input-group">
                          <div class="input-group-btn"><button type="button" class="btn btn-warning" style="width:90px;"><i class="fa fa-at"></i> Correo:</button>></div>
                    ...
                    <div class="form-group"> 
                      <div class="col-sm-12">
                        <div class="input-group">
                          <div class="input-group-btn"><button type="button" class="btn btn-warning" style="width:90px;"><i class="fa fa-car"></i> Vehiculo:</button>></div>
                          <input type="text" id="vehiculo" name="vehiculo" class="form-control" placeholder="" >
                        </div>
                        <span id="help2" class="label label-danger"></span>
                      </div>
                    </div> 
                    ...
                    <div class="col-md-0 text-center" >
                      <a class="btn btn-app bg-red" onclick="cancelarCliente()" ><i class="fa fa-refresh"></i>CANCELAR</a>
                      <a class="btn btn-app bg-green" onclick="Insertar()" ><i class="fa fa-check"></i>REGISTRAR</a>
                      <a class="btn btn-app bg-orange" onclick="consultarcliente()" ><i class="fa fa-bug"></i>LISTAR</a>
                    </div>
                    <div class="col-md-4 pull-left" style="text-align: center;" id="mensaje"></div>
							...
							<div class="box box-danger box-solid">
								<div class="box-body table-responsive no-padding">	
									<h4 class="text-center"><i class="fa fa-user text-red "></i>&nbsp;&nbsp;CLIENTES:</h4>
	  ...
	  <div id="impresion" style="display:none; visibility:hidden;">
		<center>
		 <table style="border:1px solid black; border-collapse: collapse;">
			<!-- <caption style="background-color:#eee;">CLIENTES</caption> -->
			<thead style="border:1px solid black; border-collapse: collapse; height:30px; text-align:center;">
			  <tr>
				<th style="border:1px solid black; border-collapse: collapse; height:30px; text-align:center;">NOMBRE</th>
				<th style="border:1px solid black; border-collapse: collapse; height:30px; text-align:center;">TELEFONO</th>
				<th style="border:1px solid black; border-collapse: collapse; height:30px; text-align:center;">EMAIL</th>
    ...
    function Insertar(){
        //var cliente = $("#form1").serialize()
        if ( $("#nombre").val().trim().length == 0) {
             swal({
              type: 'warning',
              html: 'Complete Nombre del Cliente !!! '
            });
             return ;
        ...
        $.ajax( { method: "POST", url: "consulta.php", data : {Nombre : nombre, Telefono: telefono, Email: email, Vehiculo: vehiculo, funcion: 'insertarCliente' }, dataType: 'json'})
/*        .done(function(rs) {
...
*/
    ...
    consultarcliente();
            swal({
              type: 'success',
              html: 'Cliente registrado !!! '
            });

    }

    function consultarcliente(){
        $.ajax( { method: "POST", url: "consulta.php", data : {funcion: 'consultarCliente' }, dataType: 'json'})
        .done(function(rs) {
          $("#resultados").html(''); 
          var body = '<tbody>';
    ...
    function Consultar() {
      ...
      $("#resultados").html('');           $( "#help1" ).text( "Ingrese algun valor !!!" ).show().fadeOut( 5000 );
      ...
      $("#contenedor").append('<center><div class="loader"><i class="fa fa-futbol-o text-danger" aria-hidden="true" style="margin-top:30%; font-size:20px;"></i></div></center>');
        ...
        $.ajax( { method: "POST", url: "consulta.php", data : {cliente : cliente , vehiculo: vehiculo , funcion: 'ConsultarClienteVehiculo' }, dataType: 'json'})
