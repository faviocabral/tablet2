  ...
  <body class="sidebar-mini skin-red fixed sidebar-collapse" >
			...
			<div class="col-md-0">
				<div class="box box-primary">
					<div class="box-header with-border">
						...
						<div class="col-md-0 pull-left" ><h3><i class="fa fa-car text-red" style="font-size:36px;" pull-left></i>&nbsp;&nbsp;ESTADO CUENTA VEHICULO</h3></div>
					</div>
					<form class="form-horizontal" id="form1" action="" onsubmit="return false;"  method="post" data-toggle="validator" >
						<div class="box-body">
							<div class="row">
                    ...
                    <div class="form-group"> 
                      ...
                      <div class="col-sm-12">
                        <div class="input-group">
                          ...
                          <input type="text" id="vin" name="vin" class="form-control "  placeholder="Ingrese 6 o mas digitos del vin" >
                       </div>
                        <span id="help1" class="label label-danger"></span>
                      </div>
                    </div> 
                    <div class="well" style="font-size:15px; margin-bottom:10px; padding:10px;">
                    <p style="margin:0px;"> <strong>OBSERVACION:</strong> </p>
                    <p style="margin:0px;"> <strong> NISSAN:</strong> </p>
                    <p style="margin:0px;">Los vin de Nissan vienen con espacios Ej: <strong>N_3N1AB7AE2ZL 808502</strong> al ingresar los 8 digitos o mas, debe ingresar con el espacio  Ej: <strong>L 808502</strong></p>
                    </div>
                    <div class="col-md-0 pull-left" >
                      <a class="btn btn-app bg-red"  onclick="Cancelar()" style="margin-left:0px;"><i class="fa fa-refresh"></i>Cancelar</a>
    ...
    function Consultar() {
      ...
      $("#contenedor").append('<center><div class="loader"><i class="fa fa-futbol-o text-danger" aria-hidden="true" style="margin-top:30%; font-size:20px;"></i></div></center>');
        ...
        $.ajax( { method: "POST", url: "consulta.php", data : {vin: vehiculo , funcion: 'ventausados', sucursal: 'alider' }, dataType: 'json'})
